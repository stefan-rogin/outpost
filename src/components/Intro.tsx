...
export const Intro = () => (
  <div className={styles.intro}>
    ...
    <p>
      ...
      resources. Click on any manufactured component to break it down into its
      inputs, good for refining your input requirements to match your production
      chains. Click on a deconstructed component to reverse its deconstruction.
    </p>
    ...
    <p>
      Clicking on <strong>Adaptive Frame</strong> changes the list of materials
      into:
    </p>
    <ul>
      <li>2 x Zero Wire</li>
    ...
    <p>
      Use the button on the right to copy your current materials list, complete
      with all deconstruction choices, to your clipboard.
    </p>
  </div>
)
